			...
			<div id="review_form">
				<?php
					...
					$comment_form = array(
						...
						'fields'               => array(
							'author' => '<p class="comment-form-author">' . '<label for="author">' . esc_html__( 'Name', 'kapee' ) . '&nbsp;<span class="required">*</span></label> ' .
										'<input id="author" name="author" type="text" autocomplete="name" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30" required /></p>',
							'email'  => '<p class="comment-form-email"><label for="email">' . esc_html__( 'Email', 'kapee' ) . '&nbsp;<span class="required">*</span></label> ' .
										'<input id="email" name="email" type="email" autocomplete="email" value="' . esc_attr( $commenter['comment_author_email'] ) . '" size="30" required /></p>',
						),
					...
					if ( wc_review_ratings_enabled() ) {
						...
						$comment_form['comment_field'] = '<div class="comment-form-rating '.esc_attr($rating_style).'"><label for="rating" id="comment-form-rating-label">' . esc_html__( 'Your rating', 'kapee' ) . ( wc_review_ratings_required() ? '&nbsp;<span class="required">*</span>' : '' ) . '</label><select name="rating" id="rating" required>
