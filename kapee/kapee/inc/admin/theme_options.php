...
if ( ! class_exists( 'Redux' ) ) {
	...
	*/
	...
	Redux::setSection( $opt_name, array(
        'title'      	=> esc_html__( 'Theme Styling', 'kapee' ),
	...
	Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
			array(
                'id'       		=> 'product-style',
                'type'     		=> 'image_select',
                'title'    		=> esc_html__( 'Product Hover Style', 'kapee' ),
                'subtitle'  	=> esc_html__( 'Choose product hover style.', 'kapee' ),
				'full_width' 	=> true,
                'options'  	=> array(
			...
			array(
				...
				'subtitle' => esc_html__( 'Show product countdown.', 'kapee' ),
                'on'       => esc_html__( 'Yes', 'kapee' ),
				'off'      => esc_html__( 'No', 'kapee' ),
				'default'  => 0,
            ),
			array(
				...
				'subtitle' 		=> esc_html__( 'Show product category.', 'kapee' ),
                'on'       		=> esc_html__('Yes','kapee'),
				'off'      		=> esc_html__('No','kapee'),
				'default'  		=> 1,
            ),
			array(
				...
				'subtitle' 		=> esc_html__( 'Show product title.', 'kapee' ),
                'on'       		=> esc_html__('Yes','kapee'),
				'off'      		=> esc_html__('No','kapee'),
				'default'  		=> 1,
            ),
			array(
				...
				'subtitle' 		=> esc_html__( 'Show product rating.', 'kapee' ),
                'on'       		=> esc_html__('Yes','kapee'),
				'off'      		=> esc_html__('No','kapee'),
				'default'  		=> 1,
            ),
			array(
				...
				'subtitle' 		=> esc_html__( 'Select product rating style.', 'kapee' ),
                'options'  		=> array(					
			...
			array(
				...
				'subtitle' 		=> esc_html__( 'Show product rating count.', 'kapee' ),
                'on'       		=> esc_html__('Yes','kapee'),
				'off'      		=> esc_html__('No','kapee'),
				'default'  		=> 1,
				'required' 		=> array( 'products-rating', '=', 1 )
			...
			array(
				...
				'subtitle' 		=> esc_html__( 'Show product price.', 'kapee' ),
                'on'       		=> esc_html__('Yes','kapee'),
				'off'      		=> esc_html__('No','kapee'),
				'default'  		=> 1,
            ),
			array(
				...
				'subtitle' 		=> esc_html__( 'Show product variations on product hover.', 'kapee' ),
                'on'       		=> esc_html__('Yes','kapee'),
				'off'      		=> esc_html__('No','kapee'),
				'default'  		=> 1,
            ),
	...
	*/
	Redux::setSection( $opt_name, array(
        'title'      => esc_html__( 'Frequently Bought Together', 'kapee' ),
        ...
        'fields'     => array(
			...
			array(
                ...
                'type'     => 'switch',
                'title'    => esc_html__( 'Frequently Bought Together', 'kapee' ),
				'subtitle' => esc_html__( 'Show frequently bought together products.', 'kapee' ),
                'on'       => esc_html__('Yes','kapee'),
				'off'      => esc_html__('No','kapee'),
				'default'  => 1,
            ),
			array(
                ...
                'title'		=> esc_html__( 'Title', 'kapee' ),
				'subtitle'  => esc_html__( 'Enter your title here.', 'kapee' ),
			...
			array(
                ...
                'type'     => 'button_set',
                'title'    => esc_html__( 'Location', 'kapee' ),
				'subtitle' => esc_html__( 'Choose location to display Bought Together Products.', 'kapee' ),
                'options'  => array(
					'summary-bottom'  	=> esc_html__('Summary Bottom','kapee'),
	...
	Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
			...
			array(
                ...
                'type'     			=> 'switch',
                'title'    			=> esc_html__( 'Product Custom Tabs', 'kapee' ),
				'subtitle'			=> esc_html__( 'Enable Custom tabs.', 'kapee' ),
                'on'       			=> esc_html__( 'Yes', 'kapee' ),
				'off'      			=> esc_html__( 'No', 'kapee' ),
				'default'  			=> 0,
            ),
			array(
				...
				'type'				=> 'repeater',
				'title'				=> esc_html__( 'Product Custom Tabs', 'kapee' ),
				'subtitle'			=> esc_html__( 'Add globally applied custom tabs to all products.', 'kapee' ),
				'bind_title'		=> 'tab_title',
				'group_values'		=> true,
				'fields'     		=> array(
					array(
						'id'          	=> 'tab_title',
						'title'   		=> esc_html__( 'Enter Tab Title', 'kapee' ),
						'type'        	=> 'text',
						'placeholder' 	=> esc_html__( 'Tab Title', 'kapee' ),
					),
					array(
						'id'      		=> 'tab_block',
						'type'    		=> 'select',
						'title'   		=> esc_html__( 'Select Block', 'kapee' ),						
						'data' 	   			=> 'posts',
						'args' 				=> array( 'post_type'=>'block','posts_per_page' => -1 ),
						//'options' 		=> pls_get_posts_by_post_type( 'block', esc_html__( 'Select Block', 'kapee' ) ),
						'desc'   		=> wp_kses( sprintf( __( 'You can create custom block from <a href="%s" target="_blank">here</a>', 'kapee' ), esc_url( admin_url( 'post-new.php?post_type=block' ) ) ), array(
						'a' => array(
							'href'   => array(),
							'target' => array(),
						),
					...
					array(
						'id'          	=> 'tab_priority',
						'title'   		=> esc_html__( 'Tab priority', 'kapee' ),
						'type'        	=> 'text',
						'placeholder' 	=> esc_html__( '40', 'kapee' ),
					),
				),
				'default'			=> array(
	...
	*/ 
    Redux::setSection( $opt_name, array(
        'title'   		=> esc_html__( 'Advance Features ', 'kapee' ),
	...
	Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
			...
			array(
                ...
                'type'     => 'textarea',
                'title'    => '',
				'subtitle' => esc_html__('Enter non functional cookies Javascript code here (for e.g. Google Analytics). It will be used after cookies are accepted.','kapee'),
				'required' => array( 'cookie-refuse-opt', '=', 1 ),
